...
//        System.out.println(new Date() + "openid:" + openid + " code:" + request.getParameter("code"));
        ...
        System.out.println("intercept--openid:" + openid);
        if ((openid == null || "".equals(openid))) {
            response.sendRedirect("https://www.efeiyi.com/wx/getUserBaseInfo.do?dataKey=openid;nickname;headimgurl&callback=dati.efeiyi.com/answer/getUserInfo2.do&source=dati");
