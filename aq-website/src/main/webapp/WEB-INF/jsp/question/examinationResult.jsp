            ...
            <div class="plan">
                ...
                <div class="txc-btn">
                    <c:if test="${examination.status == '0' && count != 0}">
                        <div id="beforeShare"><a href="#" onclick="answerHelp()" class="wechat-btn cart-ft share">我&nbsp;要&nbsp;求&nbsp;助</a></div>
    ...
    //        $("#afterShare").show();
            ...
            document.getElementById("beforeShare").innerHTML = "<a id=\"afterShare\" href=\"<c:url value='/answer/inquireProgress.do?examId=${examination.id}'/>\" class=\"wechat-btn cart-ft share\">分&nbsp;享&nbsp;进&nbsp;度</a>";
